...
public class HashRouterTest extends TestCase {
	...
	public void testDistribution() {
		...
		//prepare group assignment distribution
		double[] planned = mapDistribution(weights);
		double[] obtained = mapDistribution(counters);
		
		//compare distributions with delta
		Assert.assertArrayEquals(planned, obtained, 0.01);		
	}
